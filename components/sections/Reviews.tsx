...
const REVIEWS = [
  ...
  },
  {
    ...
    rating: 5,
    text: "Skeptical at first — I've been burned by solar 'advisors' before. But Michael laid out the numbers clearly, no pressure. The advisor call was 15 minutes and I had a quote the same day. Installed in 8 weeks.",
    initials: 'RK',
    color: 'bg-slate-600',
  },
  {
